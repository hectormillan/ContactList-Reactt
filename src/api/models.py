...
class Followers(db.Model):
    ...
    following_to = db.relationship('Users', foreign_keys=[following_id], backref=db.backref('following_to'), lazy='select')  # La relaciÃ³n
...
class Comments(db.Model):
    ...
    post_to = db.relationship("Posts", backref=db.backref("comments", lazy=True))


class Medias(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    type = db.Column(db.Enum("video","comentario"))
